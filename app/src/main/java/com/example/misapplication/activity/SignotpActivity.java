            ...
            public void onClick(View view) {
                ...
                System.out.println("empRetriveotp::::" + Rotp);
                    ...
                    if(OTpInpput.equals(Rotp)) {
                        ...
                        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLconf,
                                ...
                                new Response.ErrorListener(){
                                    ...
                                    public void onErrorResponse(VolleyError error) {
                                        ...
                                        Toast.makeText(SignotpActivity.this,error.toString(),Toast.LENGTH_LONG).show();
                        ...
                        rQueue = Volley.newRequestQueue(SignotpActivity.this);
                        rQueue.add(stringRequest);
                    }
                    else
                    {
                        Toast.makeText(SignotpActivity.this,"Otp does not match",Toast.LENGTH_LONG).show();
                    }
            }
        });
    }
